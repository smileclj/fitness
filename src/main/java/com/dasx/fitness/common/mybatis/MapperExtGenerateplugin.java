package com.dasx.fitness.common.mybatis;
...
public class MapperExtGenerateplugin extends PluginAdapter {
	...
	private void _updateDocumentNameSpace(IntrospectedTable introspectedTable, XmlElement parentElement) {
		...
		parentElement.getAttributes()
				.add(new Attribute("namespace", introspectedTable.getMyBatis3JavaMapperType() + JAVAFILE_SUFFIX));
	}

	@Override
	public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
		FullyQualifiedJavaType type = new FullyQualifiedJavaType(
				introspectedTable.getMyBatis3JavaMapperType() + JAVAFILE_SUFFIX);
